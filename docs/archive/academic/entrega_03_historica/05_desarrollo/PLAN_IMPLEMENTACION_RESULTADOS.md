...
- Create: `docs/tercera_entrega_aura/04_resultados/resultados_motor_determinista_por_regla.md`
...
const tablePath = path.resolve(__dirname, '../../docs/tercera_entrega_aura/04_resultados/resultados_motor_determinista_por_regla.md');
...
Use `fs.writeFileSync(path.join(__dirname, '../../docs/tercera_entrega_aura/04_resultados/resultados_motor_determinista_por_regla.md'), markdown)`.
