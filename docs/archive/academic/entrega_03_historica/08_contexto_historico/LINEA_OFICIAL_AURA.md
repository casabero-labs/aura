...
| Capa 1. Motor determinista | Generar hallazgos reproducibles | Diagnostico sin base factual | `src/services/auditEngine.ts`, `docs/tercera_entrega_aura/04_resultados/catalogo_reglas_motor_determinista.md` |
...
- `docs/tercera_entrega_aura/04_resultados/catalogo_reglas_motor_determinista.md`
- `docs/tercera_entrega_aura/04_resultados/tabla_comparativa_herramientas.md`
