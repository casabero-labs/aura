...
| E8-L1-001 | L1 | Tests de boundary | tests/ | Separation de modo demo/evidencia vs modo normal | Tests aún no ejecutados | Pendiente | - | Validación de boundary | Pendiente L1 |
| E8-L1-002 | L1 | Documentación de flags | docs/ | Flags de configuración de modo demo | Documentación aún no creada | Pendiente | - | Guía de configuración | Pendiente L1 |
