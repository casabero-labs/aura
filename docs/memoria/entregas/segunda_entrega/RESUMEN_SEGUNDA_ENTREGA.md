...
| OE2 | Motor determinista reproducible para anomalias estructurales. | `src/services/auditEngine.ts`, `experiments/results/deterministic_validation.json`, `docs/tablas/resultados_motor_determinista.md` |
