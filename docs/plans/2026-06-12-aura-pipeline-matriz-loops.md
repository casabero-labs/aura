...
**Files:**
- Create: `docs/memoria/entregas/tercera_entrega/MATRIZ_PIPELINE_DESARROLLO_AURA.md`
- Modify: `docs/memoria/entregas/tercera_entrega/00_INDICE_TERCERA_ENTREGA.md`
...
rg -n "MATRIZ_PIPELINE_DESARROLLO_AURA|Subir CSV|L03-A|Criterio de cierre" docs/memoria/entregas/tercera_entrega
```
