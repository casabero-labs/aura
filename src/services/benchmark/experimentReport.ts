...
export const renderExperimentReportMarkdown = (
  ...
  return [
    ...
    '',
    `Alineación F1 global con el ground truth: media ${formatNumber(aggregation.overall.diagnosticF1.mean)}, mediana ${formatNumber(aggregation.overall.diagnosticF1.median)}, mínimo ${formatNumber(aggregation.overall.diagnosticF1.min)} y máximo ${formatNumber(aggregation.overall.diagnosticF1.max)}. Es un control descriptivo frente a un registro conocido, no una prueba de descubrimiento independiente.`,
    '',
    ...
    ...scoreRows,
    '',
    `Índice equilibrado: fiabilidad 35 %, evidencia 25 %, ausencia de claims sin soporte 20 % y eficiencia 20 %. Alineación GT y contrato tienen peso 0 % porque funcionan como control descriptivo y gate de validez. ${document.decisionSupport.methodology.note}`,
    '',
