...
export const buildColabNotebook = (params: ColabNotebookParams): Notebook => {
  ...
  const header = [
    ...
    auditSummary.truncated ? '**⚠️ Auditoría truncada.** El dataset completo puede tener más filas que las auditadas.\n' : '',
    '\n',
    '---\n',
    '\n',
    '## Limitaciones\n',
    '\n',
    '- La auditoría se ejecutó en navegador sobre las filas cargadas por AURA.\n',
