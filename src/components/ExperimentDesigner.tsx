              ...
              <tbody>
                {results.map((r, i) => (
                  <tr key={i} style={styles.tableRow}>
                    ...
                    <td style={styles.td}>{r.formatCompliance ? '✓' : '✗'}</td>
...
const styles: Record<string, React.CSSProperties> = {
  container: {
    backgroundColor: 'var(--surface, #161410)',
    border: '1px solid var(--border, #2A2015)',
    borderRadius: 0,
    padding: '16px',
    fontFamily: '"JetBrains Mono", "Fira Code", monospace',
    color: 'var(--ink, #E0A020)',
    fontSize: '13px',
  },
  header: {
    marginBottom: '16px',
    borderBottom: '1px solid var(--border, #2A2015)',
    paddingBottom: '12px',
  },
  title: {
    margin: 0,
  ...
  sectionTitle: {
    ...
    fontWeight: 500,
    color: 'var(--ink, #E0A020)',
    borderBottom: '1px dashed var(--border, #2A2015)',
    paddingBottom: '6px',
  },
  table: {
    width: '100%',
  ...
  buttonPrimary: {
    backgroundColor: 'var(--ink, #E0A020)',
    color: 'var(--bg, #0D0D0C)',
    border: '1px solid var(--ink, #E0A020)',
    borderRadius: 0,
    padding: '12px 24px',
    fontSize: '14px',
    fontFamily: '"JetBrains Mono", monospace',
